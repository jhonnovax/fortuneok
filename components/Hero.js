  ...
  return (
    <section aria-labelledby="hero-title" className="max-w-7xl mx-auto bg-base-100 px-8 py-8 md:py-16 text-center relative">
      ...
      <div className="w-full flex justify-center relative mt-12 md:mt-6">
        ...
        <aside className="absolute -top-3 md:-top-4 right-4 flex -translate-y-full animate-pulse items-center gap-2 text-green-700 dark:text-primary">
          ...
          <Link href="/dashboard" className="text-green-700 dark:text-primary text-sm">Try our interactive demo</Link>
        </aside>
