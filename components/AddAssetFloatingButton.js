export default function AddAssetFloatingButton({ onAddAsset }) {
  ...
  return (
    <button 
      className="fixed bottom-3 right-0 md:bottom-4 md:right-6 btn btn-primary lg:btn-lg py-2 md:py-3 px-3 md:px-4 rounded-r-none md:rounded-full flex items-center gap-0 md:gap-2 hover:gap-2 duration-300 z-99999 box-shadow-lg group hover:scale-105 transition-transform duration-200"
      title="Add Asset"
      onClick={onAddAsset}
    >
      {/* Icon */}
