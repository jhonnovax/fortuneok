...
export default function SummaryCard({ isLoading, error, baseCurrency, filteredAssetData, totalAssetsValue, showValues, setShowValues }) {
  ...
  if (isLoading) {
    ...
    summaryUI = (
      <div className="flex flex-col 2xl:flex-row items-center mx-auto 2xl:mx-0 gap-2 md:gap-4">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          {showTotalValue && (
            <span className="tooltip tooltip-neutral" data-tip={showValues ? 'Hide values' : 'Show values'}>
              <button 
