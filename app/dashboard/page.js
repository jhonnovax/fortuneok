              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 text-lg">
                  <span className={`font-medium ${portfolioSummary.profit >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                    {portfolioSummary.profit >= 0 ? '+' : ''}{/* Add plus sign for positive values */}
                    ${Math.abs(portfolioSummary.profit).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                  </span>
                  <span className={`font-medium ${portfolioSummary.profit >= 0 ? 'text-green-600' : 'text-red-600'}`}>
