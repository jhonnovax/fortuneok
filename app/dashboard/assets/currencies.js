export const currencies = [
  ...
  { code: 'BYN', label: 'Belarusian Ruble', flag: '🇧🇾' },
  ...
  { code: 'GEL', label: 'Georgian Lari', flag: '🇬🇪' },
  ...
  { code: 'KGS', label: 'Kyrgyzstani Som', flag: '🇰🇬' },
  ...
  { code: 'PYG', label: 'Paraguayan Guaraní', flag: '🇵🇾' },
  { code: 'QAR', label: 'Qatari Riyal', flag: '🇶🇦' },
  { code: 'RON', label: 'Romanian Leu', flag: '🇷🇴' },
  { code: 'RSD', label: 'Serbian Dinar', flag: '🇷🇸' },
  ...
  { code: 'UZS', label: 'Uzbekistan Sum', flag: '🇺🇿' },
  { code: 'VEF', label: 'Venezuelan Bolívar', flag: '🇻🇪' },
